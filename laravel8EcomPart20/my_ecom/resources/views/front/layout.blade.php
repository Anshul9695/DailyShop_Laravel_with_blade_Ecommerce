          ...
          <div class="col-md-12">
            <div class="aa-header-bottom-area">
              ...
              <div class="aa-cartbox">
                <a class="aa-cart-link" href="#" id="cart_box_for_cart">
                  ...
                  <ul>
                    ...
                    <li>
                      ...
                      <div class="aa-cartbox-info">
                        ...
                        <p>{{$data->qty}}* Rs {{$data->price*$data->qty}}</p>
                      </div>
                      <a class="aa-remove-product" href="javascript:void(0)" onclick="deleteCartProduct('{{$data->pid}}','{{$data->size}}','{{$data->color}}','{{$data->attr_id}}')"><span class="fa fa-times"></span></a>
                    </li>
                    @endforeach
                    <li>
              ...
              <div class="aa-search-box">
                <form action="">
                  ...
                  <button type="button"><span class="fa fa-search" onclick="funSearch()"></span></button>
                </form>
              </div>
              <!-- / search box -->
            </div>
  ...
  <div class="modal fade" id="login-modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
   ...
   <div class="modal-body">
          ...
          <form class="aa-login-form" id="frmLogin">
            ...
            <input type="text" placeholder="Username or email" name="str_login_email" value="{{$login_email}}">
