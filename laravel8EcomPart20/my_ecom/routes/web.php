...
//PLACE ORDER OF COUSTOMER 
Route::post('place_order', [FrontController::class , 'place_order']);
Route::get('order_placed', [FrontController::class , 'order_placed']); // redirect to order place page after successfully order placed
